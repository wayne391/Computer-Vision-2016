...
cameraPoseVector1 = (R1'*[0;0;1])';%????
cameraPoseVector1 = cameraPoseVector1 / norm(cameraPoseVector1);
cameraPoseVector2 = (R2'*[0;0;1])';%????
cameraPoseVector2 = cameraPoseVector2 / norm(cameraPoseVector2);
 % camera position is row vector , please compute your matrix here
cameraPosition1  = ((R1')*(-t1))';%????
cameraPosition2  = ((R2')*(-t2))';%????
% acos(dot(cameraPoseVector1,cameraPoseVector2)) / 6.28 * 360;
angle =acos(dot(cameraPoseVector1,cameraPoseVector2)) / 6.28 * 360
%% Draw Chessboard
largeDarkFigure();
view(60,35);
hold on;
